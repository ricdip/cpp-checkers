...
Move::Move(uint8_t originFile,uint8_t originRank,uint8_t destinationFile,uint8_t destinationRank) : originFile(originFile), originRank(originRank), destinationFile(destinationFile), destinationRank(destinationRank) {}
